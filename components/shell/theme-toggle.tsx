  ...
  return (
    <>
      ...
      <motion.button
        type="button"
        className={cn(
          "att-btn group relative flex items-center justify-center gap-2 p-2 text-secondary hover:text-accent focus-visible:outline-2 focus-visible:outline-accent cursor-pointer select-none border-none bg-transparent shadow-none",
          className
        )}
        onClick={toggle}
