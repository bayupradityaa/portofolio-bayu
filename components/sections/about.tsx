...
export async function About() {
  ...
  return (
    <section id="about" className="relative w-full bg-ch-about text-foreground pt-28 pb-36 md:pt-36 md:pb-48 overflow-hidden">
      <div className="mx-auto w-full max-w-6xl px-6">
        ...
        <dl className="relative z-10 mt-16 grid grid-cols-2 gap-x-6 gap-y-10 border-t border-border/40 pt-12 md:mt-24 md:grid-cols-4">
