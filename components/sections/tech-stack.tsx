...
const logoTooltips: Record<string, string> = {
  ...
  Anthropic: "Frontier AI research & safe intelligence",
  Claude: "Advanced conversational & reasoning AI model",
  Gemini: "Google's multimodal generative AI",
  DeepSeek: "Open-source reasoning & coding AI models",
  tRPC: "End-to-end typesafe APIs for TypeScript",
  Neon: "Serverless PostgreSQL with instant branching",
  GraphQL: "Query language for your API",
  Apollo: "Industry-standard GraphQL platform",
  Bun: "Incredibly fast JavaScript all-in-one toolkit",
  Deno: "Modern secure JavaScript and TypeScript runtime",
  Zustand: "Bearbones state-management for React",
  "Shadcn UI": "Beautifully designed accessible UI components",
  "Radix UI": "Unstyled accessible UI primitives for React",
  "Drizzle ORM": "TypeScript ORM with SQL-like ergonomics",
  ...
  LangChain: "Framework for developing LLM-powered apps",
